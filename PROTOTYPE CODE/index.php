    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="vssc.html" onclick="document.getElementById('center').innerHTML='VSSC'">VSSC</a></li>
            <li><a href="lpsc.html" onclick="document.getElementById('center').innerHTML='LPSC'">LPSC</a></li>
